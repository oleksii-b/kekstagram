...
import {setPictureSrc} from 'store/actions/setPictureData';
import {pictureEditorShow, setUploadingStatus} from 'store/actions/pictureEditor';
...
function mapStateToProps(state) {
  return {
    pictureSrc: state.pictureData.src,
